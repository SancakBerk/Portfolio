      ...
      <div className="w-3/4 flex  justify-center items-center max-sm:flex-col ">
        ...
        <div className="flex flex-col p-6 w-1/2 justify-center items-center   max-sm:w-full">
          ...
          <p className="text-[#B0ADAD] text-base m-4 max-sm:text-xs text-justify ">
            Hello! I'm Berk Sancak, a dedicated software developer. I specialize
            in developing web applications using React and Next.js, and for
            mobile applications, I choose Flutter and have a strong command of
            the Bloc architecture, ensuring efficient state management and
            robust application logic in my projects.. You can find more details
            about me and explore the projects I've developed on my GitHub
